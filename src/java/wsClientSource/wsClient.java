...
public class wsClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/Assignment9WS_REST/webresources";

    public wsClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("wsSource.Products");
    }
